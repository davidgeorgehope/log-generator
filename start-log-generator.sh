...
export INDUCE_HIGH_VISITOR_RATE=true
export INDUCE_HIGH_ERROR_RATE=true
export INDUCE_HIGH_REQUEST_RATE_FROM_SINGLE_IP=true
export INDUCE_HIGH_DISTINCT_URLS_FROM_SINGLE_IP=true
